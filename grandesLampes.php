...
<html lang="fr">
    ...
    <head>
        ...
        <title>Les Lampes de Sylvie - Grandes Lampes</title>
            ...
            <div id="main_body_presentation_lamp">
                ...
                <div id="presentation_lamp">
                    <?php
                        ...
                        $reponse = $bdd->query('SELECT id, lamp_name, isAvailable, isPromo, presentation_text, url_img_cover FROM lamps WHERE lamp_type=4 AND isOnline=1 ORDER BY isPromo AND isAvailable DESC, isAvailable DESC, id DESC');
                        ...
                        while($donnees = $reponse->fetch())
                        {
                            ...
                            <div class="lamp">
                                ...
                                <p>
                                    <a href="lampe?id=<?php echo $donnees['id']; ?>" title="Découvrez <?php echo $donnees['lamp_name'] ?> !">
